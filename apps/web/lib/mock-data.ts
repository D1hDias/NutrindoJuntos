...
export const MOCK_CURSOS: Curso[] = [
  ...
  },
  {
    ...
    shortDescription: 'Domine o atendimento nutricional clínico do zero',
    price: 497,
    duration: '40 horas',
    level: 'Intermediário',
    featuredImage: {
  ...
  },
  {
    ...
    shortDescription: 'Torne-se referência em nutrição esportiva',
    price: 597,
    duration: '50 horas',
    level: 'Avançado',
    featuredImage: {
  ...
  },
  {
    ...
    shortDescription: 'Transforme seu consultório em um negócio de sucesso',
    price: 397,
    duration: '30 horas',
    level: 'Iniciante',
    featuredImage: {
